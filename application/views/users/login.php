                    ...
                    <?php $attributes = array("name" => "loginform", "role" => "form" );
                        ...
                        <fieldset>
                            ...
                            <div style="padding-top: 10px;">
                                <a href=""><label style="cursor: pointer;">Forgot Password</label></a> <a href="<?php echo site_url('/users/register');?>" class="pull-right"><label style="cursor: pointer;">Register</label></a>
                            </div>
                        </fieldset>
                    <?php echo form_close(); ?>
                </div>
